      ...
      <Animated.View style={[styles.container, { opacity: mountAnim }]}>
        ...
        <View style={[styles.header, { paddingTop: STATUS_BAR_HEIGHT + 10 }]}>
          ...
          <View style={styles.headerContent}>
            ...
            <View>
              <Text style={styles.headerTitle}>Breed Scan</Text>
              <Text style={styles.headerSubtitle}>Identify your pet's breed</Text>
            </View>
          </View>
        </View>
              ...
              {image ? (
                ...
                <View style={styles.placeholder}>
                  <View style={styles.placeholderIcon}>
                    <Ionicons name="camera-outline" size={48} color="rgba(169,139,255,0.45)" />
                  </View>
          ...
          >
            ...
            >
              <BlurView intensity={22} tint="dark" style={styles.button}>
                ...
                <Ionicons name="images-outline" size={22} color="#A98BFF" />
            ...
            >
              <BlurView intensity={22} tint="dark" style={styles.button}>
                ...
                />
                <View style={styles.buttonBorder} />
                <Ionicons name="camera-outline" size={22} color="#A98BFF" />
              ...
              >
                <BlurView intensity={28} tint="dark" style={styles.analyzeButton}>
                  ...
                  {isAnalyzing ? (
                    ...
                    <>
                      <Ionicons name="scan-outline" size={24} color="#A98BFF" />
                      <Text style={styles.analyzeText}>Identify Breed</Text>
                    </>
                  )}
                </BlurView>
              </TouchableOpacity>
              ...
              <TouchableOpacity onPress={clearImage} style={styles.clearButton}>
                <BlurView intensity={16} tint="dark" style={styles.clearButtonInner}>
                  <LinearGradient
                    ...
                    style={StyleSheet.absoluteFill}
                  />
                  <Ionicons name="close-outline" size={20} color="#FF6B4E" />
...
const styles = StyleSheet.create({
  ...
  orb2:               { width: 250, height: 250, backgroundColor: '#FF6B4E', top: height * 0.5, right: -80 },
  ...
  backButton:         { position: 'absolute', top: STATUS_BAR_HEIGHT + 15, left: 20, zIndex: 10, width: 40, height: 40, borderRadius: 20, backgroundColor: 'rgba(123,95,255,0.3)', justifyContent: 'center', alignItems: 'center' },
  ...
  placeholderIcon:    { width: 80, height: 80, borderRadius: 40, backgroundColor: 'rgba(123,95,255,0.15)', justifyContent: 'center', alignItems: 'center', marginBottom: 16, borderWidth: 1, borderColor: 'rgba(169,139,255,0.3)' },
  ...
  analyzeButton:      { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', paddingVertical: 16, paddingHorizontal: 24, borderRadius: 20, overflow: 'hidden', borderWidth: 1, borderColor: 'rgba(123,95,255,0.3)', backgroundColor: 'rgba(10,8,28,0.80)', gap: 10 },
  analyzeBorder:      { position: 'absolute', top: 0, left: 0, right: 0, height: 1, backgroundColor: 'rgba(169,139,255,0.3)' },
  analyzeText:        { fontSize: 18, fontWeight: '700', color: '#A98BFF' },
  loadingContainer:   { flexDirection: 'row', alignItems: 'center' },
  loadingText:        { fontSize: 16 },
  clearButton:        { elevation: 6 },
  clearButtonInner:   { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', paddingVertical: 10, paddingHorizontal: 20, borderRadius: 12, overflow: 'hidden', borderWidth: 1, borderColor: 'rgba(255,107,78,0.25)', backgroundColor: 'rgba(10,8,28,0.70)', gap: 6 },
  clearText:          { fontSize: 14, fontWeight: '600', color: '#FF6B4E' },
});